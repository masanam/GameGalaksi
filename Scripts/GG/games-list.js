...
//    return '<div class="content-image-banner"></div>' +
...
//            '  </div>' +
//            '</div>' +
//            '<div class="btns-container span8"><div class="btns-firstEntry"></div></div>';
//};
...
var setContentCategory = function (categoryData) {
    ...
    $('#' + elementId + ' div.content-category')
        .append('<strong>Kategori game: ' + categoryData.Name + '</strong>');
};
